...
lose1 BYTE "Thank you for your money - Jeff Bezos", 0
...
malware BYTE "C:\Users\Garrett\Downloads\malware.wav", 0
JoeBiden BYTE "C:\Users\Garrett\Downloads\joeyb.wav", 0
...
call WriteString
INVOKE PlaySound, OFFSET malware, NULL, 0h
call WaitP
call Crlf
...
call Crlf
call Crlf
;// call JoeBiden; //Draws something cool
call WaitP
call Clrscr
jmp Game
